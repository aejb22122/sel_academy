...
setwd("//pt-ad/RedirectecFolder/ajeanbaptiste/My Documents/2. PSELI/sel academy survey/SEL_academy_analysis")

# The variables of interest in our research question
# Importing the dataset
library(readxl)
seldata <- read_excel("~/2. PSELI/sel academy survey/SEL_academy_analysis/sel_academy_series_feedback_survey_2019_final_5.xlsx")
View(seldata)
